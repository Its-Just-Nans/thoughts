---
title: Télécom Paris student associations
...
export const Img = ({src, children})=>{
    const link = "https://bel-art.github.io/telecom-logos/"
    return (
        <div className="special-title">
            <a href={link} target="_blank">
            {src && (
                <Image src={src} alt="logo" className="special-img" />
            )}
            </a>
...
## <Img src={LogoForumTelecomParis}> Forum Télécom Paris</Img>
...
## <Img src={LogoMAD}>MaD - Make a Difference</Img>
...
## <Img src={LogoBDA}> BDA - Arts Office - "Bureau Des Arts"</Img>
...
## <Img src={LogoTelecomEtude}> Telecom Etude - The Junior Enterprise of Télécom Paris</Img>
...
## <Img src={LogoTelecomBusinessAndFinance}>TBF - Télécom Business and Finance</Img>
...
## <Img src={LogoBDS}>BDS - Sports Office - "Bureau Des Sports"</Img>
...
## <Img src={LogoTSM}>TSM - Télécom Sound & Magic</Img>
...
## <Img src={LogoSnax}>Snax</Img>

<Website job={"Director/Head of website departement"}>https://snax.rezel.net</Website>
...
## <Img src={LogoLH}>LH - Weekly Letter - "Lettre Hebdomadaire"</Img>
...
- This repo could be useful for future years [bel-art.github.io/telecom-logos](https://bel-art.github.io/telecom-logos/) (if it's maintained)
